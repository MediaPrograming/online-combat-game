...
public class AnimationHolder {
    ...
    private static void addAllAnimations() {
        ...
        AnimationHolder.addCharaAnimation(CharacterType.Gura, Behavior.ATTACK1 ,PATH.Gura_Attack1,128,128,7,2,6,false);
        AnimationHolder.addCharaAnimation(CharacterType.Gura, Behavior.ATTACK2 ,PATH.Gura_Attack1,128,128,7,2,6,false);
