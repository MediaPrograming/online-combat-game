...
public final class PATH {
    ...
    public static final String Kiara_Attack3 = img + "\\Kiara\\小鳥遊キアラupperattack-Sheet.png";
    public static final String Kiara_Attack4 = img +"\\Kiara\\小鳥遊キアラeat-Sheet.png";
    public static final String Kiara_Jump=img +"\\Kiara\\小鳥遊キアラjump-Sheet.png";
    public static final String Kiara_Damage= img +"\\Kiara\\小鳥遊キアラdamage-Sheet.png";

    public static final String Amelia_Normal = img + "\\Amelia\\Amerial-Nornal-01.png";
    public static final String Amelia_Attack1 = img + "\\Amelia\\Amerial-Attack-01.png";
    public static final String Amelia_Attack3 = img + "\\Amelia\\Amerial-Attack-Upper-01.png";
    public static final String Amelia_Attack4 = img + "\\Amelia\\Amerial-Attack-Under-01.png";
    public static final String Amelia_Run = img + "\\Amelia\\Amerial-Walk-01.png";
    public static final String Amelia_Atk_obj = img + "\\Amelia\\Amelia-Atk-obj.png";
    public static final String Amelia_Damaged = img + "\\Amelia\\Amerial-Damaged-01.png";
    public static final String BattleBGM = sounds + "\\BGM\\Tanukichi.wav";
